...
from .views import ListarVeiculos, CadastrarVeiculos, EditarVeiculos, ExcluirVeiculos, APINFOveiculos
...
urlpatterns = [
    ...
    path('api/listar/', APINFOveiculos.as_view(), name='api-veiculos'),
]